...
public class PanoramaActivity extends Activity implements PanoramaService.SearchListener {
     ...
     */
    private final String MAPKIT_API_KEY = "59b36ad3-39d2-4dbd-972b-7e7bf18f9cb1";
    private final Point SEARCH_LOCATION = new Point(40.190960, 44.503878);
    ...
    @Override
    public void onPanoramaSearchResult(@NonNull String panoramaId) {
